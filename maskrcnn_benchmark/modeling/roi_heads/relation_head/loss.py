...
class RelationLossComputation(object):
    ...
    def __init__(
        ...
        #xk#  begin to change; adding relation weight
        self.weight = None
        predicate_weights_path = '/data1/xukai_1/code/sgg/Scene-Graph-Benchmark.pytorch-master/datasets/vg/predicate_weights_sqrt.pkl'  #xk# 适应
        # predicate_weights_path = '/data1/xukai_1/code/sgg/Scene-Graph-Benchmark.pytorch-master/datasets/vg/predicate_weights_inverse.pkl'  # xk# 倒数
        ...
        self.criterion_loss_relation_norm = nn.CrossEntropyLoss()
        self.criterion_loss_relation_reweight = nn.CrossEntropyLoss(weight=self.weight)
    ...
    # def __call__(self, proposals, rel_labels, relation_logits, refine_logits): #xk# yuan
    def __call__(self, proposals, rel_labels, relation_logits, refine_logits, l=None): #xk#
        """
        Computes the loss for relation triplet.
        ...
        # loss_relation = self.criterion_loss(relation_logits, rel_labels.long()) #xk# yuan
        # loss_relation = self.criterion_loss_relation_reweight(relation_logits, rel_labels.long())  # xk# gai
        loss_relation = l * self.criterion_loss_relation_norm(relation_logits, rel_labels.long()) + \
                        (1 - l) * self.criterion_loss_relation_reweight(relation_logits, rel_labels.long())  # xk# bbn
