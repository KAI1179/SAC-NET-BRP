...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "VG_stanford_filtered": {
            "img_dir": "/data1/dataset/vg/VG_100K",
            "roidb_file": "/data1/dataset/vg/VG-SGG.h5",
            "dict_file": "/data1/dataset/vg/VG-SGG-dicts.json",
            "image_file": "/data1/dataset/vg/image_data.json",
        },
        "VG_stanford_filtered_with_attribute": {
            "img_dir": "/data1/dataset/vg/VG_100K",
            "roidb_file": "/data1/dataset/vg/VG-SGG-with-attri.h5",
            "dict_file": "/data1/dataset/vg/VG-SGG-dicts-with-attri.json",
            "image_file": "/data1/dataset/vg/image_data.json",
            "capgraphs_file": "/data1/dataset/vg/vg_capgraphs_anno.json",
        },
    }
