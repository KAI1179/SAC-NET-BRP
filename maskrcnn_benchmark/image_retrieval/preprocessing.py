...
# detected_path = '/data1/xukai_1/code/sgg/Scene-Graph-Benchmark.pytorch-master/output/image_retrieval/motif+rw_test/inference/VG_stanford_filtered_with_attribute_test/'
detected_path = '/data1/xukai_1/code/sgg/Scene-Graph-Benchmark.pytorch-master/output/image_retrieval/motif+rw_train/inference/VG_stanford_filtered_with_attribute_train/'
# where to save the generated annotation
# output_path = '/data1/xukai_1/code/sgg/Scene-Graph-Benchmark.pytorch-master/output/image_retrieval//motif+rw_test/sg_of_motifRW_sgdet.json'
output_path = '/data1/xukai_1/code/sgg/Scene-Graph-Benchmark.pytorch-master/output/image_retrieval//motif+rw_train/sg_of_motifRW_sgdet.json'

cap_graph = json.load(open('/data1/xukai_1/code/sgg/Scene-Graph-Benchmark.pytorch-master/datasets/vg/vg_capgraphs_anno.json'))
vg_data = h5py.File('/data1/xukai_1/code/sgg/Scene-Graph-Benchmark.pytorch-master/datasets/vg/VG-SGG-with-attri.h5', 'r')
vg_dict = json.load(open('/data1/xukai_1/code/sgg/Scene-Graph-Benchmark.pytorch-master/datasets/vg/VG-SGG-dicts-with-attri.json'))
vg_info = json.load(open('/data1/xukai_1/code/sgg/Scene-Graph-Benchmark.pytorch-master/datasets/vg/image_data.json'))
...
# vg_coco_ids = cap_graph['vg_coco_ids']
# vg_image_ids = cap_graph['vg_image_ids']
# vg_coco_id_to_caps = list(cap_graph['vg_coco_id_to_caps'].values())
# vg_coco_cap_vgid = []
# aaa = []
#
#
# for i in range(len(vg_coco_ids)):
#     if vg_coco_ids[i] != -1:
#         vg_coco_cap_vgid.append(vg_coco_ids[i])
#         aaa.append(vg_image_ids[i])
