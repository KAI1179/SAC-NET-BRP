...
def train(cfg, local_rank, distributed, logger):
    ...
    for iteration, (images, targets, _) in enumerate(train_data_loader, start_iter):
        ...
        # model.module.roi_heads.relation.predictor.current_iter = iteration #xk# jia 多卡适用
        model.roi_heads.relation.predictor.current_iter = iteration  # xk# jia 单卡适用
        ...
        # losses.backward() #xk#
        torch.nn.utils.clip_grad_norm_(model.parameters(), max_norm=20, norm_type=2) #xk# 梯度裁剪
