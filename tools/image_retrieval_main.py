...
output_path = '/data1/xukai_1/code/sgg/Scene-Graph-Benchmark.pytorch-master/output/image_retrieval/results/sg_of_motifRW_sgdet_%s_%d.pytorch'
sg_train_path = '/data1/xukai_1/code/sgg/Scene-Graph-Benchmark.pytorch-master/output/image_retrieval/motif+rw_train/sg_of_motifRW_sgdet.json'
sg_test_path = '/data1/xukai_1/code/sgg/Scene-Graph-Benchmark.pytorch-master/output/image_retrieval/motif+rw_test/sg_of_motifRW_sgdet.json'
sg_val_path = '/data1/xukai_1/code/sgg/Scene-Graph-Benchmark.pytorch-master/output/image_retrieval/motif+rw_val/sg_of_motifRW_sgdet.json'
...
def train(cfg, local_rank, distributed, logger):
    ...
    for epoch in tqdm(range(cfg.SOLVER.MAX_ITER)):
        ...
        logger.info("epoch: {epoch} loss: {loss:.6f} lr: {lr:.6f}".format(epoch=epoch, loss=float(sum(epoch_loss)), lr=optimizer.param_groups[-1]["lr"]))
